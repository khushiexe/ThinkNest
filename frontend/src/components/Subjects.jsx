  ...
  return (
    <section className='max-padd-container py-16 xl:py-20'>
      ...
      <div className='max-w-lg mx-auto text-center pb-16'>
        ...
        <p>
          Whether you're diving into math, mastering a language, or exploring
          science and tech, our subject-wise categories make it easy
        </p>
      </div>
      ...
      <div className='flexCenter flex-wrap gap-1 sm:gap-14'>
        {subjectsData.map((subject, i) => (
          <Link
            ...
            className='flexCenter flex-col bg-white h-28 w-40 rounded-xl'
          >
            <img
              src={subject.image}
              alt=''
              ...
              width={55}
            />
            <h5 className='h5 font-semibold mt-3'>
              {subject.name}
            </h5>
          </Link>
        ))}
