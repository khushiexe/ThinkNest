    ...
    <aside className="bg-white border-r border-gray-200 h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-xl py-3.5 font-semibold bg-secondary text-deep hover:scale-[1.02] transition-all duration-300"
        >
              ...
              chats.map((chat) => (
                ...
                >
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center gap-3 px-3 py-3 text-left rounded-lg ${
                      currentChatId === chat.id
                        ? "text-white"
                        : "text-gray-700 hover:text-deep"
                    }`}
                  >
