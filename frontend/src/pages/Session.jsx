...
useEffect(() => {
  ...
  const generateSlots = () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      // For today, start at the next available 30 min mark at least 1 hour later
      if (i === 0) {
            ...
            <div>
              ...
              <div className="flexBetween max-w-sm">
                ...
                <span className="relative pl-5 pr-2 ring-1 ring-slate-900/10 rounded-full">
                  <span
                    className={`absolute top-1 left-1 h-2.5 w-2.5 rounded-full bg-green-500 ${
                      !tutorInfo.available ? "bg-red-500" : "bg-green-500"
                    }`}
                  />
              ...
              <p className="flex gap-2 mb-2 mt-5">
                ...
                <span>
                  {tutorInfo.address?.city},{" "}
                  {tutorInfo.address?.country}
                </span>
              </p>
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-3 overflow-x-scroll pb-12">
                ...
                <div className="flex gap-3 overflow-x-scroll mt-4 max-w-[777px]">
                  ...
                  {availableSlots[selectedDayIndex]?.map(
                    (slot, i) => (
                      <div
                        key={i}
                        onClick={() =>
